...
def train_top_model():
    ...
    train_labels = np.array([-2]*int(nb_train_1_samples) + [-1]*int(nb_train_2_samples) + [0]*int(nb_train_3_samples) + [1]*int(nb_train_4_samples) + [2]*int(nb_train_5_samples))

    validation_data = np.load(open('bottleneck_features_validation.npy','rb'))
    validation_labels = np.array([-2] * int(nb_val_1_samples) + [-1] * int(nb_val_2_samples) + [0] * int(nb_val_3_samples)  [1] * int(nb_val_4_samples)  [2] * int(nb_val_5_samples) )

    test_data = np.load(open('bottleneck_features_test.npy', 'rb'))
    test_labels = np.array([-2]*int(nb_test_1)+[-1]*int(nb_test_2)+[0]*int(nb_test_3)+[1]*int(nb_test_4)+[2]*int(nb_test_5))
