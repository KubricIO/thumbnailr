...
def round_off(dirc, no_dp,no_files):
...
def save_bottlebeck_features():
    ...
    model = applications.densenet.DenseNet121(include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=3)


    print('1, densenet model has been loaded\n')
    ...
    np.save(open('bottleneck_features_train_densenet.npy', 'wb'),
    ...
    np.save(open('bottleneck_features_validation_densenet.npy', 'wb'),
    ...
    np.save(open('bottleneck_features_test_densenet.npy', 'wb'),
...
def train_top_model():
    ...
    train_data = np.load(open('bottleneck_features_train_densenet.npy', 'rb'))
    ...
    validation_data = np.load(open('bottleneck_features_validation_densenet.npy', 'rb'))
...
#              nb_test_5))
    ...
    print('3')
    checkpointer = ModelCheckpoint(filepath='model_class3_densenet_dense1.h5', verbose=1, save_best_only=True)
