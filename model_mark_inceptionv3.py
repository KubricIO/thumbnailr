...
def save_bottlebeck_features():
    ...
    model = applications.inception_v3.InceptionV3(include_top=False, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=3)

    print('1, inception_v3 model has been loaded\n')
    ...
    np.save(open('bottleneck_features_test_inception.npy', 'wb'),
...
#              nb_test_5))
    ...
    print('3')
    checkpointer = ModelCheckpoint(filepath='model_class3_inception_dense1.h5', verbose=1, save_best_only=True)
