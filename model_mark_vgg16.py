...
def save_bottlebeck_features():
    ...
    model = applications.VGG16(include_top=False, weights='imagenet', classes=3)
...
#              nb_test_5))
    ...
    print('3')
    checkpointer = ModelCheckpoint(filepath='model_class3_vgg16_dense1.h5', verbose=1, save_best_only=True)
